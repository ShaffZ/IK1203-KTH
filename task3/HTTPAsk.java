...
public class HTTPAsk {
    ...
    static String bad = "HTTP/1.1 400 Bad Request\r\n\r\n";
    ...
    public static void main( String[] args) {
        ...
        try {
            ...
            while(true){
                ...
                Socket connectionSo = welcomeSo.accept();
                ...
                System.out.println(Arrays.toString(uri2));

                
                System.out.println("this is get: " + get);
                System.out.println("this is http: " + http);
